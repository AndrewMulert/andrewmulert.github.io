...
export const globalErrorHandler = (err, req, res, next) => {
    ...
    let defaultHeroAlt;
    let defaultHeroTextAlt;
    let defaultHeroTextHeader;
    let defaultHeroTextParagraph;

    if (status === 400) {
        defaultHeroImage = 'error_hero_sunset';
        defaultHeroAlt = 'A Sunset by Andrew Mulert';
        defaultHeroTextAlt = "The Server ran into an issue";
        defaultHeroTextHeader = "500 Error";
        defaultHeroTextParagraph = "Please wait as we look into this issue "
    } else {
        defaultHeroImage = 'error_hero_sunset';
        defaultHeroAlt = 'The Train spanning across the distance, rendered by Andrew Mulert';
        defaultHeroTextAlt = "The Page you are looking for doesn't exist";
        defaultHeroTextHeader = "404 Error";
        defaultHeroTextParagraph = "Sorry for the inconvenience";
    }
    ...
    const context = {
        ...
        heroTextAlt: defaultHeroTextAlt,
        heroTextHeader: defaultHeroTextHeader,
        heroTextParagraph: defaultHeroTextParagraph
    };
